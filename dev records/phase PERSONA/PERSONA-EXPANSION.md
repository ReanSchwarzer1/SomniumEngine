...
Earlier [H passes](PERSONA-H.md) supply shared hover/press/toggle policy, anchored-popup continuity, node cleanup and idle/interaction regressions. The [QoL pass](PERSONA-QoL.md#expansion-feedback--2026-09-09) supplies bounded scrolling Create/View menus, alignment and viewport texel density. Its shared-picker follow-up fixes opaque asset overlays, bounds all combo lists with a draggable scrollbar, keeps search/actions fixed, and repairs generated-popup dismissal/cleanup; all 789 UI unit tests passed.
