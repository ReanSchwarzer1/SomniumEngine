...
| `wind_speed`, `foam_decay`, `foam_threshold` | 6.5, 4.5, 0.54 | Drive the spectral cascades: Wind scales the roster relative to the design 10 m/s, Foam sets grow/decay amount on foam-bearing cascades, Whitecap is the Jacobian fold threshold. |
