...
> **Status:** A–D and initial E/F implemented, with the [designer QoL follow-up](<phase PERSONA/PERSONA-QoL.md>) in tree; journey, visual and phase acceptance remain open. [A/B record and native captures](<phase PERSONA/PERSONA-A_B.md>).
...
**Expansion, 2026-09-09.** [`PERSONA-EXPANSION.md`](<phase PERSONA/PERSONA-EXPANSION.md>) adds slices **H–L** (motion wiring, surface/material/light, moments, QoL, proof) ahead of G, on the grounds that G is a finish pass and there is not yet enough surface quality for it to finish. That document is a specification and research brief only — **nothing in it is implemented**, and it proposes a narrow, enumerated amendment to [`phase_27.md`](phase_27.md) §5.2–§5.5 and §9.3 rather than a silent relaxation of the motion and decoration contract.

**Current delivery:** The [expansion H first pass](<phase PERSONA/PERSONA-H.md>) adds shared interaction motion, node cleanup and anchored-popup entry/exit; full H–L and G acceptance remain open.  A/B foundation is recorded in [PERSONA-A_B.md](<phase PERSONA/PERSONA-A_B.md>); C/D workspace and QoL implementation, tests and native evidence are in [PERSONA-C_D.md](<phase PERSONA/PERSONA-C_D.md>). C/D designer-journey acceptance remains open; implementation is not full acceptance. The [first E/F slice](<phase PERSONA/PERSONA-E_F.md>) adds contextual authoring, corrects Foliage Mode/F8, and repairs floating geometry and narrow-window clipping. The [designer QoL follow-up](<phase PERSONA/PERSONA-QoL.md>) adds material/lighting tools, browser cancellation/hover fixes, Scripts access and persistent E brush settings. Continue user review, designer journeys, the F OS/DPI matrix and G finish/acceptance; visual-baseline approval remains with the user. All floating-window and phase-wide bug-closure gates remain binding.
