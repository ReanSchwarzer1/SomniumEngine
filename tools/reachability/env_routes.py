...
ENV_ROUTES: dict[str, tuple[str, str]] = {
    ...
    "SOMNIUM_DREAMS_SEED": ("harness", "DREAMS fixture: fixed stochastic seed shared by matched A/B runs."),
    "SOMNIUM_DREAMS_RAIL": ("harness", "DREAMS fixture: named deterministic camera rail for matched captures."),
    "SOMNIUM_DREAMS_GRAIN": ("command", "editor.view.pipeline.dreams_grain"),
    "SOMNIUM_DREAMS_STF": ("command", "editor.view.pipeline.dreams_stf"),
