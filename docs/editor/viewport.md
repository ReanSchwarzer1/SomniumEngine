...
Play / Pause / Stop sit on the main toolbar. The **Profiler** toggle on the viewport bar shows GPU timings over the scene. Camera speed is the slider next to the m/s readout.
