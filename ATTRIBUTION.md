...
### 13.35 GodotOceanWaves and Sea of Thieves water refinement (Phase IV / IV-K)
...
| Asset provenance (`sea_spray.png`) | `sea_spray.png` was copied from `GodotOceanWaves-main/assets/water/sea_spray.png` into [`assets/ocean_pbr/sea_spray.png`](file:///C:/Users/adhir/OneDrive/Documents/GitHub/SomniumEngine/assets/ocean_pbr/sea_spray.png) for GPU sea spray particles, licensed under MIT / Creative Commons by 2Retr0 (https://github.com/2Retr0/GodotOceanWaves). |
