...
impl WidgetBuilder {
    pub fn new() -> Self {
        Self { widget: Widget::default() }
    }

    pub fn with_name(mut self, name: impl Into<String>) -> Self {
        self.widget.name = name.into(); self
    }
    pub fn with_width(mut self, w: f32) -> Self { self.widget.width = w; self }
    pub fn with_height(mut self, h: f32) -> Self { self.widget.height = h; self }
    pub fn with_min_size(mut self, s: Vec2) -> Self { self.widget.min_size = s; self }
    pub fn with_max_size(mut self, s: Vec2) -> Self { self.widget.max_size = s; self }
    pub fn with_margin(mut self, m: Thickness) -> Self { self.widget.margin = m; self }
    pub fn with_horizontal_alignment(mut self, a: HorizontalAlignment) -> Self {
        self.widget.horizontal_alignment = a; self
    }
    pub fn with_vertical_alignment(mut self, a: VerticalAlignment) -> Self {
        self.widget.vertical_alignment = a; self
    }
    pub fn with_background(mut self, color: [u8; 4]) -> Self { self.widget.background = color; self }
    pub fn with_foreground(mut self, color: [u8; 4]) -> Self { self.widget.foreground = color; self }
    pub fn with_visibility(mut self, v: bool) -> Self { self.widget.visibility = v; self }
    pub fn with_enabled(mut self, e: bool) -> Self { self.widget.enabled = e; self }
    pub fn with_row(mut self, r: usize) -> Self { self.widget.row = r; self }
    pub fn with_column(mut self, c: usize) -> Self { self.widget.column = c; self }
    pub fn with_children(mut self, ch: impl IntoIterator<Item = NodeHandle>) -> Self {
        self.widget.children.extend(ch); self
    }
    pub fn with_desired_position(mut self, p: Vec2) -> Self {
        self.widget.desired_local_position = p; self
    }

    /// Consume the builder and return the finished Widget.
    pub fn build(self) -> Widget { self.widget }
}
